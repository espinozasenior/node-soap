...
Client.prototype._initializeOptions = function(options) {
  ...
  this.wsdl.options.envelopeKey = options.envelopeKey || 'soapenv';
...
Client.prototype._invoke = function(method, args, location, callback, options, extraHeaders) {
  ...
  if ((style === 'rpc')&& ( ( input.parts || input.name==="element" ) || args === null) ) {
    ...
    message = self.wsdl.objectToDocumentXML("tem:" + input.$name, args, input.targetNSAlias, input.targetNamespace, (input.$type || input.$lookupType));
  }
  xml = "<?xml version=\"1.0\" encoding=\"utf-8\"?>" +
    "<" + envelopeKey + ":Envelope " +
    xmlnsSoap + " " +
    "xmlns:tt=\"http://schemas.datacontract.org/2004/07/TT.EOL.Level.BE\" " +
